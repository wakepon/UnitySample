...
public class GooglePlayRTM : SA.Pattern.Singleton<GooglePlayRTM>  {
	...
	public void SendDataToAll(byte[] data, GP_RTM_PackageType sendType) {
		...
		case GP_RTM_PackageType.RELIABLE:
			...
			GP_RTM_ReliableMessageListener listener = new GP_RTM_ReliableMessageListener(SA.Util.IdFactory.NextId, data);
