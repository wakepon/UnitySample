...
public class AndroidNativeSettingsEditor : Editor {
	...
	public static void UpdateVersionInfo() {
		SA.Util.Files.Write(SA_VersionsManager.AN_VERSION_INFO_PATH, AndroidNativeSettings.VERSION_NUMBER);
	...
	private void Actions() {
		...
		if(GUILayout.Button("Reset Settings",  GUILayout.Width(160))) {
			...
			SA.Util.Files.DeleteFile("Extensions/AndroidNative/Resources/AndroidNativeSettings.asset");
	...
	public static void UpdateManifest() {
		...
		////////////////////////
		AN_PropertyTemplate LocalNotificationService = application.GetOrCreatePropertyWithName("service", "com.androidnative.features.notifications.LocalNotificationService");
		...
		AN_PropertyTemplate ReceiverIntentFilter = LocalNotificationReceiver.GetOrCreateIntentFilterWithName ("com.androidnative.local.intent.OPEN");
	...
	private static void UpdateAppID() {
		if (!SA.Util.Files.IsFolderExists("Plugins/Android/AN_Res/res/values")) {
		...
		EditorGUI.indentLevel++; {
			...
			if(EditorGUI.EndChangeCheck())  {
				...
				if(AndroidNativeSettings.Instance.OneSignalEnabled) {
					if(!(SA.Util.Files.IsFolderExists("Plugins/OneSignal") || SA.Util.Files.IsFolderExists("OneSignal"))) {
		...
		EditorGUI.indentLevel++; {
			...
			if(EditorGUI.EndChangeCheck())  {				
				if(AndroidNativeSettings.Instance.UseParsePushNotifications) {
					if(!SA.Util.Files.IsFolderExists("Parse")) {
		...
		EditorGUI.indentLevel++; {
			...
			if(EditorGUI.EndChangeCheck())  {
				...
				if(!AndroidNativeSettings.Instance.EnableSoomla) {
					...
					if(SA.Util.Files.IsFileExists("Plugins/IOS/libSoomlaGrowLite.a")) {
	...
	public static void LocalNotificationParams() {
		...
		if (EditorGUI.EndChangeCheck ()) {
			if (AndroidNativeSettings.Instance.LocalNotificationLargeIcon != null) {
				...
				if (AndroidNativeSettings.Instance.PushNotificationLargeIcon != null) {
					if (!AndroidNativeSettings.Instance.PushNotificationLargeIcon.name.Equals(AndroidNativeSettings.Instance.LocalNotificationLargeIcon.name)) {
						SA.Util.Files.DeleteFile("Plugins/Android/AN_Res/res/drawable/" + AndroidNativeSettings.Instance.LocalNotificationLargeIcon.name.ToLower() + Path.GetExtension(path));
					}
				} else {
					SA.Util.Files.DeleteFile("Plugins/Android/AN_Res/res/drawable/" + AndroidNativeSettings.Instance.LocalNotificationLargeIcon.name.ToLower() + Path.GetExtension(path));
				}
			...
			if (icon != null) {
				...
				SA.Util.Files.CopyFile(path.Substring(path.IndexOf("/"), path.Length - path.IndexOf("/")),
			...
			if (AndroidNativeSettings.Instance.LocalNotificationSmallIcon != null) {
				...
				if (AndroidNativeSettings.Instance.LocalNotificationSmallIcon != null) {
					if (!AndroidNativeSettings.Instance.LocalNotificationSmallIcon.name.Equals(AndroidNativeSettings.Instance.LocalNotificationSmallIcon.name)) {
						SA.Util.Files.DeleteFile("Plugins/Android/AN_Res/res/drawable/" + AndroidNativeSettings.Instance.LocalNotificationSmallIcon.name.ToLower() + Path.GetExtension(path));
					}
				} else {
					SA.Util.Files.DeleteFile("Plugins/Android/AN_Res/res/drawable/" + AndroidNativeSettings.Instance.LocalNotificationLargeIcon.name.ToLower() + Path.GetExtension(path));
				}
			...
			if (AndroidNativeSettings.Instance.LocalNotificationSound != null) {
				...
				if (AndroidNativeSettings.Instance.PushNotificationSound != null) {
					if (!AndroidNativeSettings.Instance.PushNotificationSound.name.Equals(AndroidNativeSettings.Instance.LocalNotificationSound.name)) {
						SA.Util.Files.DeleteFile("Plugins/Android/AN_Res/res/raw/" + AndroidNativeSettings.Instance.LocalNotificationSound.name.ToLower() + Path.GetExtension(path));
					}
				} else {
					SA.Util.Files.DeleteFile("Plugins/Android/AN_Res/res/raw/" + AndroidNativeSettings.Instance.LocalNotificationSound.name.ToLower() + Path.GetExtension(path));
				}
	...
	public static void PushNotificationParams() {
		...
		if (EditorGUI.EndChangeCheck ()) {
			if (AndroidNativeSettings.Instance.PushNotificationLargeIcon != null) {
				...
				if (AndroidNativeSettings.Instance.LocalNotificationLargeIcon != null) {
					if (!AndroidNativeSettings.Instance.PushNotificationLargeIcon.name.Equals(AndroidNativeSettings.Instance.LocalNotificationLargeIcon.name)) {
						SA.Util.Files.DeleteFile("Plugins/Android/AN_Res/res/drawable/" + AndroidNativeSettings.Instance.PushNotificationLargeIcon.name.ToLower() + Path.GetExtension(path));
					}
				} else {
					SA.Util.Files.DeleteFile("Plugins/Android/AN_Res/res/drawable/" + AndroidNativeSettings.Instance.PushNotificationLargeIcon.name.ToLower() + Path.GetExtension(path));
				}
			...
			if (AndroidNativeSettings.Instance.PushNotificationSmallIcon != null) {
				...
				if (AndroidNativeSettings.Instance.PushNotificationSmallIcon != null) {
					if (!AndroidNativeSettings.Instance.PushNotificationSmallIcon.name.Equals(AndroidNativeSettings.Instance.PushNotificationSmallIcon.name)) {
						SA.Util.Files.DeleteFile("Plugins/Android/AN_Res/res/drawable/" + AndroidNativeSettings.Instance.PushNotificationSmallIcon.name.ToLower() + Path.GetExtension(path));
					}
				} else {
					SA.Util.Files.DeleteFile("Plugins/Android/AN_Res/res/drawable/" + AndroidNativeSettings.Instance.PushNotificationSmallIcon.name.ToLower() + Path.GetExtension(path));
				}
		...
		if (EditorGUI.EndChangeCheck ()) {
			if (AndroidNativeSettings.Instance.PushNotificationSound != null) {
				...
				if (AndroidNativeSettings.Instance.LocalNotificationSound != null) {
					if (!AndroidNativeSettings.Instance.PushNotificationSound.name.Equals(AndroidNativeSettings.Instance.LocalNotificationSound.name)) {
						SA.Util.Files.DeleteFile("Plugins/Android/AN_Res/res/raw/" + AndroidNativeSettings.Instance.PushNotificationSound.name.ToLower() + Path.GetExtension(path));
					}
				} else {
					SA.Util.Files.DeleteFile("Plugins/Android/AN_Res/res/raw/" + AndroidNativeSettings.Instance.PushNotificationSound.name.ToLower() + Path.GetExtension(path));
				}
