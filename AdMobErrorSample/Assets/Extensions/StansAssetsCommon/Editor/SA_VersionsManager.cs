...
public static class SA_VersionsManager  {
	...
	public static bool Is_AN_Installed {
		get { 
			return SA.Util.Files.IsFileExists(AN_VERSION_INFO_PATH);
		}
	}
	...
	public static bool Is_MSP_Installed {
		get {
			return SA.Util.Files.IsFileExists(MSP_VERSION_INFO_PATH);
		}
	}
	...
	public static bool Is_UM_Installed {
		get {
			return SA.Util.Files.IsFileExists(UM_VERSION_INFO_PATH);
		} 
	}
	...
	public static bool Is_GMA_Installed {
		get {
			return SA.Util.Files.IsFileExists(GMA_VERSION_INFO_PATH);
		} 
	}
	...
	public static bool Is_MNP_Installed {
		get {
			return SA.Util.Files.IsFileExists(MNP_VERSION_INFO_PATH);
		} 
	}
	...
	public static bool Is_ISN_Installed {
		get {
			return SA.Util.Files.IsFileExists(ISN_VERSION_INFO_PATH);
		} 
	}
	...
	private static int GetMagorVersionCode(string versionFilePath) {
		string stringVersionId = SA.Util.Files.Read (versionFilePath);
	...
	private static string GetStringVersionId(string versionFilePath) {
		if(SA.Util.Files.IsFileExists(versionFilePath)) {
			return SA.Util.Files.Read (versionFilePath);
		} else {
			return "0.0";
		}
	}
