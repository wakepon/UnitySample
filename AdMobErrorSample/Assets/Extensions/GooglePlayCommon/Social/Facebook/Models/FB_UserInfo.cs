...
public class FB_UserInfo {
	...
	public void LoadProfileImage(FB_ProfileImageSize size) {
		...
		case FB_ProfileImageSize.large:
			SA.Util.Loader.LoadWebTexture(GetProfileUrl(size), OnLargeImageLoaded);
			break;
		case FB_ProfileImageSize.normal:
			SA.Util.Loader.LoadWebTexture(GetProfileUrl(size), OnNormalImageLoaded);
			break;
		case FB_ProfileImageSize.small:
			SA.Util.Loader.LoadWebTexture(GetProfileUrl(size), OnSmallImageLoaded);
			break;
		case FB_ProfileImageSize.square:
			SA.Util.Loader.LoadWebTexture(GetProfileUrl(size), OnSquareImageLoaded);
			break;
